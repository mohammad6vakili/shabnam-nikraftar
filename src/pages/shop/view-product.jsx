...
import productImage from "../../assets/shop/viewProductImage.svg";
  ...
  return (
    <div className="view-product">
      ...
      <div className="view-product-action">
        <Button className="mv-button">افزودن به سبد خرید</Button>
        <div>
      ...
      <div className="view-product-header">
        {/* header nav */}
        <div className="view-product-header-nav">
          <div>
            <img
              onClick={() => {
                history.push("/shop");
              ...
              alt="back"
            />
            <span className="bold">خرید محصول</span>
          </div>
          <div>
            <img
              onClick={() => {
      ...
      <div className="view-product-description">
        ...
        <div className="view-product-title">
          <div className="bold">
            کرم مرطوب کننده و آبرسان ایباگ مدل شیر گاو وزن 80 گرم
          </div>
          <div>
        ...
        <div className="view-product-menus">
          <div>
            <span className="bold">معرفی محصول</span>
            <img src={leftArrowIcon} alt="open menu" />
          </div>
          <div>
            <span className="bold">نظرات کاربران</span>
            <img src={leftArrowIcon} alt="open menu" />
          </div>
          <div>
          ...
          <div style={{ borderBottom: "none" }}>
            <span className="bold">بلاگ‌های مرتبط</span>
            <img src={leftArrowIcon} alt="open menu" />
          </div>
        </div>
      </div>
